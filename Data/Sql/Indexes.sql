...
CREATE NONCLUSTERED INDEX [IX_Order_UserId] ON [Order] ([UserId] ASC)
GO
...
CREATE NONCLUSTERED INDEX [IX_ShoppingCartItem_ShoppingCartTypeId_UserId] ON [ShoppingCartItem] ([ShoppingCartTypeId] ASC, [UserId] ASC)
GO
