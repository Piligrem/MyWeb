...
DROP INDEX [IX_User_UserGuid] ON [User]
GO
...
DROP INDEX [IX_Order_UserId] ON [Order]
GO
...
DROP INDEX [IX_ShoppingCartItem_ShoppingCartTypeId_UserId] ON [ShoppingCartItem]
GO
...
DROP INDEX [IX_Forums_Post_UserId] ON [Forums_Post]
GO
