...
namespace InSearch.Data.Setup
{
    ...
    /// </summary>
    public class InstallDatabaseInitializer : MigrateDatabaseInitializer<InSearchObjectContext, MigrationsConfiguration>
    {
        #region Ctor
        ...
        /// <inheritdoc />
        public override void InitializeDatabase(InSearchObjectContext context)
        {
