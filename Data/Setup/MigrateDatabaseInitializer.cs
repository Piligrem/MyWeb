...
namespace InSearch.Data.Setup
{
        ...
        where TConfig : DbMigrationsConfiguration<TContext>, new()
    {
        ...
        #region Properties
        public IEnumerable<IDataSeeder<TContext>> DataSeeders { get; set; }

        public IEnumerable<string> TablesToCheck { get; set; }
        ...
        public virtual void InitializeDatabase(TContext context)
        {
            ...
            if (tablesExist)
            {
                ...
                if (!hasHistoryEntry)
                {
                    ...
                    // We MUST assume that the database was created with a previous InSearch version
