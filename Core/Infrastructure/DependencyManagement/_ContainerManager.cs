...
{
    public class _ContainerManager
    {
        private readonly IContainer _container;

        public _ContainerManager(IContainer container)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null)
                            throw new InSearchException("Unknown dependency");
                        parameterInstances.Add(service);
                    }
                    return Activator.CreateInstance(type, parameterInstances.ToArray());
                }
                catch (InSearchException)
                {

                }
            }
            throw new InSearchException("No constructor was found that had all the dependencies satisfied.");
        }
    ...
    public static class _ContainerManagerExtensions
    {
