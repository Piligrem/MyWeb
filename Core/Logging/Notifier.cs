...
namespace InSearch.Core.Logging
{
    ...
    {
        void Add(NotifyType type, /*LocalizedString*/ string message, bool durable = true);
    ...
    public static class INotifierExtension
    {
        ...
        public static void Success(this INotifier notifier, /*LocalizedString*/ string message, bool durable = true)
        {
            notifier.Add(NotifyType.Success, message, durable);
        }

        public static void Warning(this INotifier notifier, /*LocalizedString*/ string message, bool durable = true)
        {
            notifier.Add(NotifyType.Warning, message, durable);
        }

        public static void Error(this INotifier notifier, /*LocalizedString*/ string message, bool durable = true)
        {
