...
namespace InSearch.Core.Logging
{
    public class TraceLogger : DisposableObject, ILogger
    {
        ...
        public TraceLogger() : this(CommonHelper.MapPath("~/App_Data/InSearch.log")) { }
        ...
        public void InsertLog(LogLevel logLevel, string shortMessage, string fullMessage = "", User user = null)
        {
