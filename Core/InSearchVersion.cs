...
{
    public static class InSearchVersion
    {
        ...
        {
            get { return "{0}.{1}".FormatInvariant(s_infoVersion.Major, s_infoVersion.Minor); }
        }
        ...
        {
            get { return s_infoVersion.ToString(); }
        }

        internal static Version FullVersion
        {
            get { return s_infoVersion; }
        }

        /// <summary>
        /// Gets a list of PVServer.NET versions in which breaking changes occurred,
        ...
        {
            get { return s_breakingChangesHistory.AsEnumerable(); }
        }
    }
}
