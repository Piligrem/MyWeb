...
namespace InSearch.Collections
{
    [Serializable]
    public class ThreadSafeList<T> : IList<T>, IList
    {
        ...
        #region Constructors
        public ThreadSafeList() : this(new ReaderWriterLockSlim()) { }
        ...
        public ThreadSafeList(int capacity) : this(capacity, null) { }
        ...
        public ThreadSafeList(IEnumerable<T> collection) : this(collection, null) { }
