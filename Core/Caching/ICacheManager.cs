...
namespace InSearch.Core.Caching
{
    ...
    public interface ICacheManager
    {
        ...
        /// <remarks>
        /// This method internally wraps either a <c>ReaderWriterLockSlim</c> or an empty noop action dependending on the scope of the underlying <c>ICache</c> implementation.
