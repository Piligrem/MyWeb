...
namespace InSearch.Core.Email
{
    ...
    public class Attachment
    {
        ...
        {
            get { return _attachment.ContentType; }
            set { _attachment.ContentType = value; }
        }
        public string Name
        {
            get { return _attachment.Name; }
            set { _attachment.Name = value; }
        }
        public string MediaType
        {
            get { return _attachment.ContentType.MediaType; }
            set { _attachment.ContentType.MediaType = value; }
        }
        public ContentDisposition ContentDisposition
        {
            get { return _attachment.ContentDisposition; }
        }
        public TransferEncoding ContentTransferEncoding
        {
            get { return _attachment.TransferEncoding; }
            set { _attachment.TransferEncoding = value; }
        }
