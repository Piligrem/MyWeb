...
namespace InSearch.Core.Email
{
    public class EmailMessage : ICloneable<EmailMessage>
    {
		...
		public EmailMessage(string to, string subject, string body, string from) : this()
		{
		...
		public EmailMessage(EmailAddress to, string subject, string body, EmailAddress from) : this()
		{
