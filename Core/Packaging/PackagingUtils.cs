...
namespace InSearch.Core.Packaging
{
    ...
    public static class PackagingUtils
    {
        ...
        {
            return string.Format("InSearch.{0}.", extensionType);
        }
        ...
        //        MinAppVersion = InSearchVersion.FullVersion, // TODO: (pkg) Add SupportedVersion to theme manifests
