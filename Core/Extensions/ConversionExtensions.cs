...
namespace InSearch
{
    public static class ConversionExtensions
    {
        ...
        static ConversionExtensions()
        {
            ...
            var nameValueCollectionConverter = new GenericListTypeConverter<NameValueCollection>();
            ...
            s_customTypeConverters.Add(typeof(NameValueCollection), nameValueCollectionConverter);
        }
        ...
        public static T ConvertForModel<T>(this object value)
        {
            var jsonString = string.Empty;
            jsonString = JsonConvert.SerializeObject(value, Formatting.None,
        ...
        public static object ConvertForModel(this object value)
        {
