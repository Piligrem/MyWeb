...
//using InSearch.Services.Catalog;
//using InSearch.Services.Topics;
...
namespace InSearch.Services.Seo
{
    ...
    public partial class SitemapGenerator : BaseSitemapGenerator, ISitemapGenerator
    {
		...
		public SitemapGenerator(//ISiteContext siteContext, ICategoryService categoryService,
        ...
        private void WriteTopics()
        {
            ...
            //var topics = _topicService.GetAllTopics(_siteContext.CurrentStore.Id).ToList().FindAll(t => t.IncludeInSitemap);
