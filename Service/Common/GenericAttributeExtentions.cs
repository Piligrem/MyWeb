...
namespace InSearch.Services.Common
{
    public static class GenericAttributeExtentions
    {
            ...
            string key, IGenericAttributeService genericAttributeService)
        {
            ...
            return genericAttributeService.GetAttribute<TPropType>(keyGroup, entity.Id, key);
        }

        public static TPropType GetAttribute<TPropType>(this IGenericAttributeService genericAttributeService, string entityName, int entityId, string key)
        {
