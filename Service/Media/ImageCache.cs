...
namespace InSearch.Services.Media
{
    public class ImageCache : IImageCache
    {
        ...
        public ImageCache(MediaSettings mediaSettings, IWebHelper webHelper, ISiteContext siteContext, HttpContextBase httpContext)
        {
            this._mediaSettings = mediaSettings;
            this._webHelper = webHelper;
            this._storeContext = siteContext;
        ...
        public virtual string GetImageUrl(string imagePath, string storeLocation = null)
        {
            ...
            if (root.IsEmpty())
            {
                var cdnUrl = _storeContext.CurrentSite.ContentDeliveryNetwork;
