...
namespace InSearch.Services.Media
{
    ...
    public partial interface IPictureService
    {
        ...
        Size GetPictureSize(int pictureId);
        ...
        /// <param name="defaultPictureType">Default picture type</param>
        /// <returns>Picture URL</returns>
        string GetPictureUrl(int pictureId, int targetSize = 0, bool showDefaultPicture = true, PictureType defaultPictureType = PictureType.entity);
        ...
        /// <param name="defaultPictureType">Default picture type</param>
        /// <returns>Picture URL</returns>
        string GetPictureUrl(Picture picture, int targetSize = 0, bool showDefaultPicture = true, PictureType defaultPictureType = PictureType.entity);

        string GetPhotoUrl(int pictureId);
        ...
        Picture GetPictureById(int pictureId, PictureType defaultPictureType = PictureType.entity);
