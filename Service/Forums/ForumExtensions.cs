...
namespace InSearch.Services.Forums
{
    public static class ForumExtensions
    {
        ...
        public static string FormatForumSignatureText(this string text)
        {
            ...
            text = InSearch.Core.Html.HtmlUtils.FormatText(text, false, true, false, false, false, false);
            return text;
        }
        ...
        public static string FormatPrivateMessageText(this PrivateMessage pm)
        {
            ...
            text = InSearch.Core.Html.HtmlUtils.FormatText(text, false, true, false, true, false, false);
        ...
        /// <summary>
        /// Get forum last post user
        /// </summary>
        /// <param name="forum">Forum</param>
        /// <param name="userService">User service</param>
        /// <returns>User</returns>
        public static User GetLastPostUser(this Forum forum, IUserService userService)
        {
            if (forum == null)
                throw new ArgumentNullException("forum");

            return userService.GetUserById(forum.LastPostUserId);
        }
        ...
        /// <param name="userService">User service</param>
        /// <returns>User</returns>
        public static User GetLastPostUser(this ForumTopic forumTopic, IUserService userService)
        {
            if (forumTopic == null)
                throw new ArgumentNullException("forumTopic");

            return userService.GetUserById(forumTopic.LastPostUserId);
        }
    }
}
