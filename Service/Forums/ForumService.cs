...
namespace InSearch.Services.Forums
{
    /// <summary>
    /// Forum service
    /// </summary>
    ...
    {
        #region Constants
        private const string FORUMGROUP_ALL_KEY = "InSearch.forumgroup.all";
        private const string FORUM_ALLBYFORUMGROUPID_KEY = "InSearch.forum.allbyforumgroupid-{0}";
        private const string FORUMGROUP_PATTERN_KEY = "InSearch.forumgroup.";
        private const string FORUM_PATTERN_KEY = "InSearch.forum.";
        #endregion
        ...
        private bool IsForumModerator(User user)
        {
        ...
        public virtual IPagedList<ForumTopic> GetAllTopics(int forumId,
            int userId, string keywords, ForumSearchType searchType,
        ...
        public virtual ForumTopic MoveTopic(int forumTopicId, int newForumId)
        {
            ...
            if (this.IsUserAllowedToMoveTopic(_workContext.CurrentUser, forumTopic))
            {
        ...
        public virtual IPagedList<ForumPost> GetAllPosts(int forumTopicId, int userId, string keywords, int pageIndex, int pageSize)
        {
        ...
        public virtual IPagedList<ForumPost> GetAllPosts(int forumTopicId, int userId, string keywords, bool ascSort, int pageIndex, int pageSize)
        {
        ...
        public virtual IPagedList<PrivateMessage> GetAllPrivateMessages(int fromUserId,
        ...
        public virtual void InsertPrivateMessage(PrivateMessage privateMessage)
        {
            ...
            if (userTo == null)
            {
                throw new InSearchException("Recipient could not be loaded");
            }

			//UI notification
			_genericAttributeService.SaveAttribute(userTo, SystemUserAttributeNames.NotifiedAboutNewPrivateMessages, false);
        ...
        public virtual IPagedList<ForumSubscription> GetAllSubscriptions(int userId, int forumId, int topicId, int pageIndex, int pageSize)
        {
        ...
        public virtual bool IsUserAllowedToCreateTopic(User user, Forum forum)
        {
            ...
            if (user.IsGuest() && !_forumSettings.AllowGuestsToCreateTopics)
            {
                return false;
            }
        ...
        public virtual bool IsUserAllowedToCreatePost(User user, ForumTopic topic)
        {
            ...
            if (user.IsGuest() && !_forumSettings.AllowGuestsToCreatePosts)
            {
                return false;
            }
