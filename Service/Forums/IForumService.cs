...
namespace InSearch.Services.Forums
{
    ...
    public partial interface IForumService
    {
        ...
        IPagedList<ForumPost> GetAllPosts(int forumTopicId, int userId,
        ...
        IPagedList<PrivateMessage> GetAllPrivateMessages(int fromUserId,
        ...
        IPagedList<ForumSubscription> GetAllSubscriptions(int userId, int forumId,
