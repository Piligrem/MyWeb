...
namespace InSearch.Services.Security
{
    public partial class PermissionService : IPermissionService
    {
        #region Constants
        /// <summary>
        /// Cache key for storing a value indicating whether a certain user role has a permission
        /// </summary>
        /// <remarks>
        /// {0} : user role id
        /// {1} : permission system name
        /// </remarks>
        private const string PERMISSIONS_ALLOWED_KEY = "InSearch.permission.allowed-{0}-{1}";
        private const string PERMISSIONS_PATTERN_KEY = "InSearch.permission.";
        #endregion
